<template>
  <div
    class="bg-white p-2 rounded mt-1 border-b border-gray-400 cursor-pointer hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-800 dark:border-gray-900"
  >
    {{ title }}
    <div
      class="text-gray-800 dark:text-gray-100 mt-2 ml-2 flex justify-between items-start"
    >
